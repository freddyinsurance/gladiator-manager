// API Base URL - Cambiar a tu dominio en producción
const API_URL = 'api';
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                showNotification('⚠️ Ya existe un registro para este agente en esta fecha. Por favor, edita el registro existente.', 'error');
            } else {
...
async function loadRecords() {
    ...
    if (agentName) url += `agent_name=${agentName}&`;
